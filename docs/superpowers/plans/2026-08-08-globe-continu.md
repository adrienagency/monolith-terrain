...
- [ ] **Étape 1 — DÉVERROUILLER `this.busy` ET `demBusy`. ⚠️ CE PLAN N'AVAIT ICI QUE DES CONSTATS, SANS UN SEUL VERBE À L'IMPÉRATIF.**
  ...
  - ⚠️ **LE CRITÈRE EST DONC COMPARATIF, ET C'EST LE SEUL HONNÊTE.** Mesurez les **trois** régimes — verrou actuel, file, cible coalescée — sur **trois scénarios** : rafale (6 crans en 1 s), hésitation (20 crans alternés), descente de référence. **La cible doit battre le verrou actuel sur les trois, et l'écart décisif est l'hésitation** : c'est là que la file explose à 29,75 s et que la cible tient à 3,90 s. ⚠️ **Si votre cible ne bat pas le verrou d'aujourd'hui sur les trois scénarios, vous n'avez rien gagné : dites-le et arrêtez-vous.**
