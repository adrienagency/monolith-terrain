...
const CLOUD_PRESETS = [
  { id: 'epars', label: 'Épars', v: { cloudCoverage: 0.68, cloudBillow: 0.5, cloudContrast: 1.2, cloudOpacity: 1.0 } },
  { id: 'couvert', label: 'Couvert', v: { cloudCoverage: 0.22, cloudBillow: 0.15, cloudContrast: 0.7, cloudOpacity: 1.1 } },
  { id: 'drama', label: 'Dramatique', v: { cloudCoverage: 0.45, cloudBillow: 0.95, cloudContrast: 1.8, cloudOpacity: 1.5 } },
]
const CLOUD_TIPS = {
